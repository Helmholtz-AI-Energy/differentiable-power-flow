...
def main():
    ...
    for case_name in case_names:
        ...
        with open(
            f"out/temp/ex10a_TO_{to_optimizer}_{case_name}_{use_gpu}.pkl", "rb"
        ) as readFile:
    ...
    running_min_to_normalized_losses = np.minimum.accumulate(
        to_normalized_losses, axis=1
    )  # use best loss
    ...
    for iter in iterations_to_plot:
        ...
        normalized_losses_at_iter = [
            100 * x[iter - 1] for x in running_min_to_normalized_losses
        ]
